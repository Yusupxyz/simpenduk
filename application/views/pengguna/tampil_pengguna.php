            ...
            foreach ($pengguna as $pengguna) {
              ?>
                        <tr>
                            ...
                            <td><?php echo ($pengguna->level == 'kepaladesa') ? 'Kepala Desa' : (($pengguna->level == 'sekretaris') ? 'Sekretaris Desa' : (($pengguna->level == 'kaurpemerintahan') ? 'Kaur Pemerintahan' : 'Admin')); ?></td>
